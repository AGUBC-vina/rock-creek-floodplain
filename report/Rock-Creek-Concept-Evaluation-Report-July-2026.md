---
title: "Rock Creek Floodwater Spreading, Recharge, and Floodplain Reactivation"
subtitle: "Concept Evaluation Report — North and South Diversion Corridors, Butte County, California"
author: "Prepared by the Agricultural Groundwater Users of Butte County (AGUBC)"
date: "July 2026"
---
...
The purpose of this report is to give Butte County leadership and other stakeholders — partner agencies, the Vina and Rock Creek Reclamation District GSA boards, environmental and funding partners, and the engineers who will build on this work — a complete, source-cited picture of the Rock Creek floodwater spreading concept at its current stage of development, in a form suitable for evaluation, review, and further engineering. The concept has four objectives:
...
![Figure 1. Project vicinity — Rock Creek, Keefer Slough, Sand Creek, and the two proposed overland corridors, northwest of Chico, Butte County, California.](figures/fig01-vicinity.png)
...
![Figure 2. The four-dataset spread at Rock Creek upstream of the bifurcation. The 100-year estimates range from 5,600 to 8,020 cfs across the three tabulated datasets; the DWR 2D model adds a fourth framing at specific cross-sections.](figures/fig02-dataset-fan.png)
...
![Figure 3. Keefer Slough Q100 near Garner Lane: FEMA FIS effective value (680 cfs) versus DWR 2D model (2,391 cfs) — a 3.52× difference at the same location.](figures/fig03-garner-lane.png)
...
![Figure 4. The bifurcation flow split, then and now: 56/44 (Rock Creek / Keefer Slough) per the 2011 FIS versus 39/61 per the DWR 2D model under current channel conditions.](figures/fig04-bifurcation-shift.png)
...
![Figure 5. The concept on the project map (same base map as Figure 1; flood flow runs northeast to southwest): (1) divert only at high flow, ~1.1 miles upstream of the bifurcation; (2) spread and slow through hundreds of low rock weirs along two corridors; (3) soak in and reactivate floodplain along ~10.4 miles; (4) return the remainder to Rock Creek near SR 99 — lower, slower, later.](figures/fig05-concept-on-map.png)
...
![Figure 6. Plan view of a typical 600-foot reach with three weirs at 200-foot spacing. Flow left to right; backwater pools overlap; planting zones run in concentric bands from wetland fringe to terrace edge.](figures/fig06-reach-plan.png)

![Figure 7. Cross-section A–A at a weir, looking downstream. The 2.5-foot weir crest matches the bench top, so above-crest flow both passes downstream and spills laterally onto the bench. The shaded layer at depth flags the shallow restrictive layer documented in the Sand Creek Infiltration Study — the reason weir placement must be screened reach by reach.](figures/fig07-section-at-weir.png)

![Figure 8. Cross-section B–B midway between weirs. No structure in this section, but the downstream weir's backwater keeps the channel inundated through the wet season, supporting a wider wet-meadow band.](figures/fig08-section-between-weirs.png)
...
| What does not | Dam attenuation results, $164–286M mitigation, dam costs | Per-basin recharge volumes (dam-pond specific) | Any flood claims (none analyzed); Caltrans mitigation funding model |
...
## 5.3 One Project, Three Frameworks: Restoration, Flood Protection, Recharge

The concept reads differently — and is fundable differently — depending on which of its three faces a program values. All three are genuine:

**As an environmental restoration project.** Ten-plus miles of reactivated floodplain is, on its own terms, one of the larger riparian-wetland restoration opportunities on the valley floor of Butte County: winter-ponded weir pools that function as seasonal shallow-water habitat of the kind the Pacific Flyway's shorebird and waterfowl programs deliberately create; wet-meadow, riparian, and oak-terrace bands from the reach-design planting palettes (Section 4.7); pollinator and monarch habitat on the corridor margins, where native milkweed and nectar plantings are a low-cost designed element on working lands **[VERIFY: palette confirmation by a restoration ecologist]**; and habitat connectivity along the Rock Creek–Sand Creek corridor for species state programs already track — Swainson's hawk, tricolored blackbird, and giant garter snake among the candidates **[VERIFY: species occurrence via CNDDB query and biologist confirmation]**. The environmental case does not ride on the water numbers: it accrues every wet season, in every recharge scenario.

**As flood protection with a direct disadvantaged-community benefit.** The attenuation benefit lands first on the community of Nord — small, entirely groundwater-dependent, reliant on shallow domestic wells, with documented flood exposure in this very corridor — and on the SR 99 travel corridor. Proposition 4 directs 40 percent of bond funds to projects delivering meaningful and direct benefits to disadvantaged communities; a project that attenuates flood peaks upstream of Nord while wetting the shallow zone its wells draw from is a strong candidate under that test **[VERIFY: DAC/SDAC designation mapping for Nord; flood-routing confirmation in the Phase 2 screening]**.

**As a Flood-MAR / recharge project.** The concept fits squarely inside California's Flood-MAR framework — the state's endorsed approach for diverting high flows onto floodplains and working lands for recharge, flood-risk reduction, and habitat, explicitly tied to SGMA — and it now sits alongside the Component 5 preliminary designs for basin-type FloodMAR projects on the same corridor (Section 2.5): the basins concentrate recharge at tested high-capacity sites; the weir corridor distributes it along ~10 miles of channel and floodplain.

One programmatic note cuts across all three: California's land-repurposing funders score "recharge" narrowly — the Multibenefit Land Repurposing Program's current guidelines expressly exclude floodplain restoration and temporary-storage infiltration features from counting as groundwater recharge (DOC, 2025) — so for that family of programs the concept should lead with exactly what is most certain about it: **flood protection, habitat, and the Nord benefit, with recharge presented as the substantial co-benefit it is** (Section 6.2). The most accurate single description remains: a Flood-MAR floodplain-reactivation project on the local Nord / Sand Creek geometry, executed with the rock-detention toolkit of the USGS pilots, with Singer Creek as the land-control and stewardship model.
...
**Would have to be true:** less than the section heading implies. The concept stands primarily on flood attenuation and floodplain reactivation — benefits that do not depend on deep percolation. Recharge is the third leg: real and valuable, but its **magnitude** is the open question, not the project's viability. Shallow hardpan across parts of the corridor means some reaches will deliver soil-moisture, wet-meadow, and shallow-zone benefits rather than deep recharge; the deep-recharge estimate concentrates in the favorable alluvial reaches, where the Sand Creek study and the Component 5 confluence pilots found genuine capacity. What must be true for the recharge *estimate* — not for the project — is that enough of the corridor overlies those favorable conditions to justify the central case.
...
Section 1242.1 permits diversion of flood flows for recharge **without an appropriative right** when a local or regional agency has publicly noticed imminent flood risk — and its use has already been **demonstrated locally** by the Component 5 pilots. Two constraints matter: the authority currently applies only to diversions initiated through **January 1, 2029**, and the flood-notice trigger limits operation to roughly 3–6 days per year on average in this system — approximately 3 under the statute as written, approximately 4–6 once the Executive Order N-16-25 streamlining and the proposed AB 2026 changes are accounted for, with wet years supporting 6–10 (Geosyntec, 2026, Sec. 7.1). Section 7.4 of this report examines what those 3 days mean for yield. The practical strategy that follows: use §1242.1 for early pilot operation while it remains available, and begin the appropriative-right (or TUCP) process in the roadmap's Phase 3 so the long-term pathway matures as the project does. **This framing identifies the candidate pathways; it is not a legal conclusion, and water-rights counsel is a named early work item.**
...
**Would have to be true:** less a feasibility gate than a maintenance-design question. Sediment will collect — that is partly what grade control is for — and the corrective is inspection and resetting rock: a distributed, low-unit-cost fix with none of the consequences sediment carries at a dam (storage loss, downstream starvation, regulated outlet works). What must actually be true is narrower: accumulation must stay within a routine maintenance cycle the endowment can fund, rather than compounding into a progressive failure mode.
...
Sections 8 and 10 present the order-of-magnitude answer: a central-case ~$30 million capital cost, of which roughly 75 percent is plausibly grant-fundable across programs whose stated priorities — multi-benefit recharge, flood risk reduction, habitat, SGMA implementation — read almost as a description of this concept; a beneficiary share on the order of $8 million one-time including a ~$3 million endowment; and **no recurring annual assessment**, because endowment yield is designed to carry the ~$120,000-per-year operating cost. Phasing can cut the entry ticket further than the two-corridor split in Section 8.1 suggests: an initial phase limited to the intake and a single corridor — or an intake built at partial capacity plus a pilot reach — is a legitimate scoping option for Phase 1 engineering and would lower the first funding ask accordingly.
...
The Component 5 analysis found that flood-only diversion under Water Code §1242.1 offers approximately **3 days per year** of qualifying diversion opportunity in this system as the statute stands — rising to approximately **4–6 days per year on average, and 6–10 in wet years**, once the Executive Order N-16-25 streamlining and the proposed AB 2026 expansions are accounted for (Geosyntec, 2026, Sec. 7.1). The corridor model above assumes **15–60 days per year of inundation**. These two numbers describe different things, and the distinction matters:
...
![Figure 10. Central-case annual recharge (~5,000–7,000 AF/yr band) in context against the Vina Subbasin's ~8,000 AF/yr current storage growth.](figures/fig10-recharge-context.png)
...
![Figure 11. Central-case capital by category. Land control (G) likely falls toward ~$1–1.5M if the four-landowner picture is confirmed; contingency (J) is carried at concept-stage levels.](figures/fig11-cost-categories.png)
...
Roughly **75 percent of the central-case capital — about $22 million — is plausibly grant-fundable**, blended across the programs surveyed in Section 10 (categories A–D each rate 75–100 percent eligible against current program criteria; the endowment is the hard piece, at 0–30 percent). The remaining **~$8 million beneficiary share** — of which ~$3 million is the endowment — substantially **is** the local match most grant programs require (typically 25–50 percent), rather than a cost on top of it. Cost-allocation across beneficiaries (Vina Subbasin landowners and GSA payers, Butte County, Caltrans, agricultural groundwater users, the Tuscan Water District, private philanthropy) is a conversation for a later phase; the technical annex carries a starting-point allocation keyed to benefit received, and mitigation-style revenue (Section 10) could reduce the share materially.

![Figure 12. The central-case funding stack: ~$22M grant-funded (~75%) over multiple tranches; ~$8M beneficiary share, of which ~$3M is the perpetual O&M endowment.](figures/fig12-funding-stack.png)
...
In the framing that governs the local conversation: **local beneficiaries — the flood-protection, water-supply, and environmental interests this project serves — contribute ~$8M of a ~$30M project, and in return receive ~6,000 AF/yr of new recharge alongside the flood and habitat dividend: about $77 per acre-foot, well below the California surface-water market range of $300–2,000/AF.**

![Figure 13. Three cost framings, beneficiary share first: ~$77/AF (beneficiary), ~$212/AF (grant-funded), ~$308/AF (total project), against the $300–2,000/AF California surface-water transaction band.](figures/fig13-three-framings.png)
...
![Figure 14. Master sequence, Phases 0–5 over roughly 60 months. The gold diamond marks the go/no-go gate at approximately month 12: the major-landowner decision, informed by the FDEM subsurface screen.](figures/fig14-master-sequence.png)
...
![Figure 15. The decision ladder: screening spreadsheet → HEC-RAS 2D routing → engineered design, each gating the next stage of spending.](figures/fig15-decision-ladder.png)
...
The funding landscape for exactly this project type is strong, recently refreshed — and it rewards the multi-benefit framing of Section 5.3. At the state level, **Proposition 4 (2024)** allocates approximately $3.8 billion for water resilience, including groundwater recharge, flood management, and multi-benefit land repurposing (Geosyntec, 2026, Sec. 8), and **directs 40 percent of bond funds to projects delivering meaningful benefits to disadvantaged communities** (Pub. Resources Code, Div. 50) — which makes the Nord benefit a scoring asset, not a footnote. DWR's SGM and IRWM programs continue as the recharge workhorses; **DWR Flood-MAR resilience funding** and the new **Watershed Resilience Program** are the most precisely targeted fits for a multibenefit flood-groundwater-ecosystem corridor. The **Multibenefit Land Repurposing Program** (Department of Conservation) funds floodplain expansion and habitat on repurposed agricultural land — but three structural facts should shape any approach to it: it operates as regional block grants through a GSA-anchored lead rather than project applications; its current guidelines credit "recharge" narrowly (Section 5.3); and Proposition 4 defines the eligible nonprofit lead as a 501(c)(3), which points applications toward the Vina GSA or the County, with AGUBC coordinating. SWRCB stormwater grants and CWSRF financing can supplement construction. Federally, **FEMA BRIC/FMA** fund flood-risk reduction (the project must appear in local hazard mitigation plans), **NRCS** programs (EQIP, RCPP, ACEP easements, and the PL-566 watershed program) align with the corridor's agricultural-easement reality, and **Reclamation WaterSMART** supports design and construction at 50 percent non-federal share. The **Wildlife Conservation Board** stacks no-match habitat grants onto exactly these elements — its Inland Wetlands Conservation Program covers the Butte Basin, and its Monarch Butterfly and Pollinator Rescue Program is purpose-built for the corridor-margin pollinator plantings.

Four strategy notes govern the approach. **Layer, don't lump:** a ~$30M project is fundable as 3–5 tranches aligned with phasing, not as one award; this is also Component 5's stated strategy for its sites. **The beneficiary share is the match:** most programs require 25–50 percent local participation, which the ~$8M share satisfies by design — verify each program's match-stacking rules individually. **The endowment is raised, not granted:** plan on local stakeholders, agency reserves, and a private-foundation lead gift for the ~$3M seed. **Public-agency partnership is structural:** most programs require a public co-applicant or fiscal agent; the Vina GSA and Butte County are the natural partners, and AGUBC's role in Component 5 is the working precedent for that structure.

Finally, the habitat itself can contribute revenue. A full mitigation bank is **not recommended** — additionality rules (habitat used as the project's own permit basis cannot be resold as credits) plus a $2–5M establishment cost and thin regional credit demand defeat it. But a **single-buyer mitigation agreement** — most plausibly with Caltrans, whose SR 99 program has both a documented flood nexus and recurring mitigation needs, on the Singer Creek template — plus opportunistic **in-lieu-fee participation** could contribute meaningfully over project life, reducing the beneficiary share or fortifying the endowment — with the scale set by Caltrans's actual mitigation needs in this corridor rather than assumed in advance.

# 11. References

Butte County Department of Water and Resource Conservation, 2024. *Butte County Recharge Action Plan.* February 13, 2024.

California Department of Conservation (DOC), 2025. *Multibenefit Land Repurposing Program, Round 1 and Round 2 Guidelines,* as amended April 21, 2025.
...
Proposition 4 — Safe Drinking Water, Wildfire Prevention, Drought Preparedness, and Clean Air Bond Act of 2024. Public Resources Code, Division 50.
...
*Prepared by the Agricultural Groundwater Users of Butte County (AGUBC), July 2026, for discussion with Butte County leadership, partner agencies, and local stakeholders. Concept-stage synthesis; not engineering, legal, or water-rights advice.*
